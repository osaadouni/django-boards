...
class PostUpdateViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.post = Post.objects.create(message='Lorem ipsum dolor sit amet', topic=self.topic, 
            created_by=user
        )
...
class AuthorizedPostUpdateViewTests(PostUpdateViewTestCase):
    def setUp(self):
        super().setUp()
...
class PostUpdateViewTests(PostUpdateViewTestCase):
    ...
    def test_view_class(self):
        post_edit_url = '/boards/{board_pk}/topics/{topic_pk}/posts/{post_pk}/edit/'.format(
            board_pk=self.board.pk,
            topic_pk=self.topic.pk,
            post_pk=self.post.pk
        )
        view = resolve(post_edit_url)
